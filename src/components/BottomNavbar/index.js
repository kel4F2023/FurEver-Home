  ...
  return (
    <div className="fixed bottom-0 w-full flex justify-around bg-white border-t border-gray-300 py-2">
      <Link href="/visit-shelter">
        <div className="flex-1 flex flex-col items-center text-center py-2 cursor-pointer primary-color  transform transition-transform duration-200 active:scale-75">
